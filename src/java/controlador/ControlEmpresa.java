 ...
 */
@WebServlet(name = "ControlEmpresa", urlPatterns = {"/ControlEmpresa"})
public class ControlEmpresa extends HttpServlet {

    private DAO_Empresa da;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            this.da = new DAO_Empresa();
            this.empresaList = new ArrayList<>();
            this.empresaList = this.da.getListEmpresa();
            request.setAttribute("listaEmpresa", this.empresaList);
