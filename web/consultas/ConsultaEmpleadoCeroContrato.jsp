<%-- 
    Document   : ConsultaEmpleadoCeroContrato
    Created on : 10-23-2021, 09:11:52 AM
    ...
    <body>
        <form >
            <div class="container-fluid">
                <center><h2>Vendedores sin Contratos Realizados</h2></center>
                <table class="table table-responsive table-bordered navbarResponsive" 
                    ...
                    <tbody>
                        <%
                            List<Empleado> lsEmpleadoC = (List<Empleado>) request.getAttribute("listitaEmpleadoC");
                            for (Empleado registro : lsEmpleadoC) {
                        %>
                        <tr class="table table-bordered table-responsive">
